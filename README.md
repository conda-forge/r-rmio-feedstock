...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rmio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12998&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rmio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rmio` can be installed with:

```
conda install r-rmio
```

It is possible to list all of the versions of `r-rmio` available on your platform with:
